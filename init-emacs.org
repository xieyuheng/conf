...
** [babel] evaluation
   ...
   #+end_src
** [agenda]
   file:/home/xyh/.org-agenda-files
   #+begin_src emacs-lisp :tangle "~/.emacs"
...
*** after-make-frame-functions
    利用after-make-frame-functions这个hook
    在使用emacs --daemon的时候设置emacsclient的字体
    #+begin_src emacs-lisp :tangle "~/.emacs"
    (defun frame-setting ()
      ;; 英文
      (set-face-attribute 'default nil :family "monaco" :height 100)
      ;; 中文
      (set-fontset-font t 'han (font-spec :name "MS Song" :size 16))
      (set-fontset-font t 'cjk-misc (font-spec :name "MS Song"))
      (set-fontset-font t 'kana (font-spec :name "MS Song"))
      ;; 符号
...
**** playing
     ...
     λλλλλλλλλλλλ|
     #+begin_src emacs-lisp
     ;; 文泉驿点阵宋体, :size 14 已经是最大号了
     (set-fontset-font t 'han (font-spec :name "WenQuanYi Bitmap Song" :size 14))

     ;; 文泉驿微米黑
     (set-fontset-font t 'han (font-spec :name "WenQuanYi Micro Hei Mono" :size 16))

     ;; 文鼎PL简中楷
     (set-fontset-font t 'han (font-spec :name "AR PL KaitiM GB" :size 16))

     ;; 文鼎PL简报宋
     (set-fontset-font t 'han (font-spec :name "AR PL SungtiL GB" :size 16))

     ;; 覆盖范围广 不错的楷体
     (set-fontset-font t 'han (font-spec :name "MS Song" :size 16))

     ;; 华秀月明 覆盖很广
     (set-fontset-font t 'han (font-spec :name "H\-秀月" :size 16))

     (set-fontset-font t 'han (font-spec :name "H\-雲林呉竹体" :size 16))

     (set-fontset-font t 'han (font-spec :name "H\-儷黑" :size 16))

     (set-fontset-font t 'han (font-spec :name "H\-新雅蘭" :size 16))

     ;; 有点不适合印刷
     (set-fontset-font t 'han (font-spec :name "H\-宮書" :size 16))

     (set-fontset-font t 'han (font-spec :name "PMingLiU\-TW" :size 16))
     (set-fontset-font t 'han (font-spec :name "臺灣新細明體" :size 16))

     (set-fontset-font t 'han (font-spec :name "H\-明蘭" :size 16))

     (set-fontset-font t 'han (font-spec :name "simsun" :size 16))

     (set-fontset-font t 'han (font-spec :name "" :size 16))
     (set-fontset-font t 'han (font-spec :name "" :size 16))
     (set-fontset-font t 'han (font-spec :name "" :size 16))
     (set-fontset-font t 'han (font-spec :name "" :size 16))
     (set-fontset-font t 'han (font-spec :name "" :size 16))
...
** no-bother
   ...
   buffer
   if the value is nil
   and `inhibit-startup-screen' is nil
   show the startup screen

   :tangle "~/.emacs"
   #+begin_src emacs-lisp
   (setq initial-buffer-choice "kkk")
   #+end_src
