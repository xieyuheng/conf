...
*** cicada
    ...
    (setq auto-mode-alist (cons `("\\.cs\\'" . cicada-mode) auto-mode-alist))
    (setq auto-mode-alist (cons `("\\.cl\\'" . cicada-mode) auto-mode-alist))
    (setq auto-mode-alist (cons `("\\.cp\\'" . cicada-mode) auto-mode-alist))
    (setq auto-mode-alist (cons `("\\.cc\\'" . cicada-mode) auto-mode-alist))
...
*** idris
    ...
    (add-hook
     ...
     (lambda ()
       (local-set-key (kbd "M-n") 'forward-paragraph)
       (local-set-key (kbd "M-p") 'backward-paragraph)
       (local-set-key (kbd "<return>") (lambda (interactive) (insert "\n")))
       (turn-off-indent)))
    #+end_src
...
***** 宋
      ...
      ;; (set-fontset-font t 'han (font-spec :name "臺灣新細明體" :size 28))
      #+end_src
...
***** 黑
      ...
      ;; (set-fontset-font t 'han (font-spec :name "Noto Sans CJK TC Thin" :size 28))
      ;; (set-fontset-font t 'han (font-spec :name "Noto Sans CJK TC Light" :size 28))

      ;; (set-fontset-font t 'han (font-spec :name "Noto Sans CJK TC DemiLight" :size 28))

      ;; (set-fontset-font t 'han (font-spec :name "Noto Sans CJK TC Medium" :size 28))
      ;; (set-fontset-font t 'han (font-spec :name "Noto Sans CJK TC Bold" :size 28))
      ;; (set-fontset-font t 'han (font-spec :name "Noto Sans CJK TC Black" :size 28))
      #+end_src
