...
**** playing
     ...
     λλλλλλλλλλλλ|
     #+begin_src emacs-lisp
     ;; 文泉驿点阵宋体, :size 16 已经是最大号了
     (set-fontset-font t 'han (font-spec :name "WenQuanYi Bitmap Song" :size 16))

     ;; 文泉驿微米黑
     (set-fontset-font t 'han (font-spec :name "WenQuanYi Micro Hei Mono" :size 20))

     ;; 文鼎PL简中楷
     (set-fontset-font t 'han (font-spec :name "AR PL KaitiM GB" :size 20))

     ;; 文鼎PL简报宋
     (set-fontset-font t 'han (font-spec :name "AR PL SungtiL GB" :size 20))
     ...
     (set-fontset-font t 'han (font-spec :name "PMingLiU\-TW" :size 20))
     ...
     (set-fontset-font t 'han (font-spec :name "" :size 20))
     (set-fontset-font t 'han (font-spec :name "" :size 20))
     (set-fontset-font t 'han (font-spec :name "" :size 20))
     (set-fontset-font t 'han (font-spec :name "" :size 20))
     (set-fontset-font t 'han (font-spec :name "" :size 20))
