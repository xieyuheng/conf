...
*** markdown
    ...
    (custom-set-faces
     '(fixed-pitch ((t (:inherit font-lock-constant-face)))))

    (setq markdown-fontify-code-blocks-natively t)markdown-inline-code-face
...
*** 楷
    ...
    #+begin_src emacs-lisp :tangle ~/.emacs
    ;; (set-fontset-font t 'han (font-spec :name "MS Song" :size 40))
...
*** 黑
    ...
    #+begin_src emacs-lisp :tangle ~/.emacs
    (set-fontset-font t 'han (font-spec :name "H-雲林呉竹体" :size 44))
